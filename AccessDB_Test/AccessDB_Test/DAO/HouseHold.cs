...
namespace AccessDB_Test.DAO
{
    class HouseHold
    {
        ...
        public List<string> beneficiaryTypesList;
        public List<string> hostingDisplacedPeopleList;
        public List<string> martialStatusList;
        public List<string> displacementStatusList;
        public List<string> returneeStatusList;
        public List<string> shelterStatusList;
        public List<string> incomeList;
        public List<string> originalGovernorateList;
